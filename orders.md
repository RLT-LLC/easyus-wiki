...
> Доступно функционалям: **Исполнитель, Менеджер, Модератор**. Для использования чата необходимо быть назначеным исполнителем или ответственным на заказе
{.is-info}
...
> Доступно функционалям: **Менеджер, Модератор**. Для использования приватного чата необходимо быть назначеным исполнителем или ответственным на заказе
{.is-info}
