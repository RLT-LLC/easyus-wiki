...
> В следующих главах документации вы познакомитесь со всем функционалом Easyus CRM. Инструкции по использованию представлены в текстовом виде, а также ниже есть демонстрация основого функционала в видео формате
{.is-info}
